...
//     await mutex.lock(); // Mengunci mutex
//     try {
...
//             },1000*Math.random())
//         });
//         console.log('Successfully accessed critical section');
//     } catch (error) {
//         console.log('Error in critical section:', error);
//     } finally {
//         mutex.unlock(); // Pastikan untuk membuka kunci, meskipun ada kesalahan
//         console.log('Mutex unlocked');
//     }
// }

// async function main() {
//     const tasks = [criticalSection, criticalSection, criticalSection];

//     await Promise.all(tasks.map((task) => task())); // Menjalankan beberapa fungsi asinkron secara bersamaan
// }
